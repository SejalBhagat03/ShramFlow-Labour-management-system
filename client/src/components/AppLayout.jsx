...
export const AppLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { path: '/flagged', icon: AlertTriangle, label: t('flagged'), badge: null },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* Main Content Area */}
            <main className="lg:ml-72 pt-16 lg:pt-0 min-h-screen transition-all duration-300">
                {/* Desktop Header */}
                <header className="hidden lg:flex items-center justify-end h-16 px-8 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-40">
                    <div className="flex items-center gap-4">
                        <NotificationBell />
                        <div className="h-8 w-[1px] bg-border/60 mx-1" />
                        <div className="flex items-center gap-3">
                            <span className="text-sm font-medium text-muted-foreground">Hello, {user?.name?.split(' ')[0] || 'User'}</span>
