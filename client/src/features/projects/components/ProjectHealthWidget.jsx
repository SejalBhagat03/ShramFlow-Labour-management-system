                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-black">
                                {prediction.predictedEndDate && prediction.predictedEndDate !== 'Unknown' && !isNaN(new Date(prediction.predictedEndDate).getTime())
                                    ? new Date(prediction.predictedEndDate).toLocaleDateString() 
                                    : 'TBD'}
                            </span>
