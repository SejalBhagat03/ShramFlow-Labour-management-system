...
const chatbotTranslations = {
    en: {
        chatTitle: "ShramFlow Assistant",
        placeholder: "Ask me anything...",
        greeting: "Hello! I'm your ShramFlow assistant. How can I help you today? You can also speak to me!",
    ...
    hi: {
        chatTitle: "श्रमफ्लो सहायक",
        placeholder: "कुछ भी पूछें...",
        greeting: "नमस्ते! मैं आपका श्रमफ्लो सहायक हूं। आज मैं आपकी कैसे मदद करूं? आप बोलकर भी पूछ सकते हो!",
        errorMessage: "माफ करें, कुछ गड़बड़ हो गई। फिर से कोशिश करें।",
        typing: "लिख रहा है...",
        listening: "सुन रहा हूं...",
        speakNow: "अब बोलें...",
        voiceNotSupported: "इस ब्राउज़र में वॉइस नहीं चलेगी",
...
export const Chatbot = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            const assistantContent = data.message || t.errorMessage;
