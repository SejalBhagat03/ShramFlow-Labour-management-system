...
export const DailyWorkWizard = ({ labourerId, userId, onComplete }) => {
    ...
    const labels = {
        startWork: { en: "START WORK", hi: "काम शुरू करो" },
        takePhoto: { en: "Take Photo", hi: "फोटो लो" },
        finishWork: { en: "FINISH WORK", hi: "काम खत्म" },
        beforePhoto: { en: "Before Photo", hi: "पहले की फोटो" },
        afterPhoto: { en: "After Photo", hi: "बाद की फोटो" },
        howManyMeters: { en: "How many meters?", hi: "कितने मीटर?" },
        submit: { en: "SUBMIT", hi: "जमा करो" },
        done: { en: "Work Saved!", hi: "काम दर्ज हो गया!" },
        newEntry: { en: "New Entry", hi: "नया एंट्री" },
        working: { en: "Working...", hi: "काम चल रहा है..." },
        locationCaptured: { en: "Location captured", hi: "जगह दर्ज हुई" },
    };
    ...
    const renderStep = () => {
        switch (step) {
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        >
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span>{labels.startWork[lang]}</span>
                            </div>
                        </Button>
                ...
                return (
                    <div className="flex flex-col items-center gap-6">
                        <div className="text-center mb-4">
                            ...
                            <p className="text-xl font-semibold">{labels.beforePhoto[lang]}</p>
                        </div>
                        <Button
                            size="lg"
                ...
                return (
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="text-center">
                            <p className="text-lg text-muted-foreground animate-pulse">{labels.working[lang]}</p>
                        ...
                        >
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span>{labels.finishWork[lang]}</span>
                            </div>
                        </Button>
                    </div>
                );
            ...
            case "after_photo":
                return (
                    <div className="flex flex-col items-center gap-6">
                        <div className="text-center mb-4">
                            <Camera className="h-16 w-16 mx-auto text-primary mb-2" />
                            <p className="text-xl font-semibold">{labels.afterPhoto[lang]}</p>
                        </div>
                        <Button
                            size="lg"
                            className="w-40 h-40 rounded-full text-xl font-bold gradient-primary shadow-glow"
            ...
            case "meters":
                return (
                    <div className="flex flex-col items-center gap-6">
                        <p className="text-xl font-semibold">{labels.howManyMeters[lang]}</p>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-center min-w-[120px]">
                                ...
                                <p className="text-lg text-muted-foreground">{lang === "hi" ? "मीटर" : "meters"}</p>
                            </div>
                        ...
                        {!isOnline && (
                            <p className="text-sm text-warning text-center">
                                {lang === "hi" ? "इंटरनेट नहीं है। बाद में भेजा जाएगा।" : "No internet. Will be sent later."}
                            </p>
                        )}
                    </div>
                );
            ...
            case "complete":
                return (
                    <div className="flex flex-col items-center gap-6 animate-scale-in">
                        ...
                        <p className="text-2xl font-bold text-success">{labels.done[lang]}</p>
                        <p className="text-lg text-muted-foreground">
                            {meters} {lang === "hi" ? "मीटर दर्ज हुआ" : "meters recorded"}
                        </p>
                        <Button variant="outline" size="lg" onClick={resetWizard} className="mt-4">
                            <RotateCcw className="h-5 w-5 mr-2" />
                            {labels.newEntry[lang]}
                        </Button>
                    </div>
                );
        }
                ...
                {isCapturingLocation && (
                    <div className="absolute inset-0 bg-background/50 flex items-center justify-center">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-sm">{lang === "hi" ? "जगह ढूंढ रहे हैं..." : "Getting location..."}</p>
                        </div>
                    </div>
                )}
            </CardContent>
