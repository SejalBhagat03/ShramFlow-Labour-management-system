    ...
    const statCards = [
        {
            ...
            icon: Users,
            trend: stats.totalLabourers > 0 ? { value: 12, positive: true } : undefined,
        },
        {
        ...
        {
            title: t('flaggedEntries'),
            value: stats.flaggedEntries,
            icon: AlertTriangle,
            variant: stats.flaggedEntries > 0 ? 'warning' : 'default',
        },
    ];
                            ...
                            {statsLoading ? (
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center text-sm p-3 rounded-xl bg-primary/5">
                                        <span className="text-muted-foreground font-medium">Total Meters</span>
                                    ...
                                    <div className="flex justify-between items-center text-sm p-3 rounded-xl bg-warning/5">
                                        <span className="text-muted-foreground font-medium">Pending Reviews</span>
                                        <span className="font-bold text-warning text-lg">{stats.pendingPayments}</span>
                                    </div>
                                </div>
                            )}
                        </div>
